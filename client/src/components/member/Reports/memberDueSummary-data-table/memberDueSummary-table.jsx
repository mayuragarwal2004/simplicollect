...
import { MemberDueSummaryPagination } from './memberDueSummary-pagination.jsx'

export function MemberDueSummaryTable({
 columns,
 data,
 searchInputField,
 filterField,
 ...
 return (
  <div className="space-y-4">
   ...
   <MemberDueSummaryPagination table={table} totalRecord={totalRecord} />
  </div>
 )
}
