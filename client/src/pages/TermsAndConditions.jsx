    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10 dark:bg-gray-800">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          this Agreement) refers to Simplium Technologies, Office No. 37, First
          Floor, Sagar Complex, Kasarwadi, Pune-411034.
        </li>
        <li className="mb-2">
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">
          By email: faq@simplicollect.in
        </li>
        <li className="mb-2">
          By phone number: +91 98230 44860
        </li>
      </ul>
    </div>
  );
