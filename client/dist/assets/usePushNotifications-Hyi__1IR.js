var vt=Object.defineProperty;var It=(t,e,n)=>e in t?vt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var B=(t,e,n)=>It(t,typeof e!="symbol"?e+"":e,n);import{C as Fe,P as p,c as $,r as C,b as St,Q as R}from"./index-eKwCJLll.js";const _t=()=>{};var me={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ot=()=>kt().__FIREBASE_DEFAULTS__,Nt=()=>{if(typeof process>"u"||typeof me>"u")return;const t=me.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},Pt=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&Dt(t[1]);return e&&JSON.parse(e)},Mt=()=>{try{return _t()||Ot()||Nt()||Pt()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},xe=()=>{var t;return(t=Mt())===null||t===void 0?void 0:t.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D=new Map,Bn=new Map,re=new Map;function Ie(t,e){try{t.container.addComponent(e)}catch(n){b.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function S(t){const e=t.name;if(re.has(e))return b.debug(`There were multiple attempts to register component ${e}.`),!1;re.set(e,t);for(const n of D.values())Ie(n,t);for(const n of Bn.values())Ie(n,t);return!0}function ce(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,n,r){this._isDeleted=!1,this._options=Object.assign({},e),this._config=Object.assign({},n),this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=r,this.container.addComponent(new E("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}checkDestroyed(){if(this.isDeleted)throw w.create("app-deleted",{appName:this._name})}}function qe(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ne,automaticDataCollectionEnabled:!0},e),i=r.name;if(typeof i!="string"||!i)throw w.create("bad-app-name",{appName:String(i)});if(n||(n=xe()),!n)throw w.create("no-options");const o=D.get(i);if(o){if(Q(n,o.options)&&Q(r,o.config))return o;throw w.create("duplicate-app",{appName:i})}const s=new Vt(i);for(const c of re.values())s.addComponent(c);const a=new $n(n,r,s);return D.set(i,a),a}function Fn(t=ne){const e=D.get(t);if(!e&&t===ne&&xe())return qe();if(!e)throw w.create("no-app",{appName:t});return e}function Se(){return Array.from(D.values())}function y(t,e,n){var r;let i=(r=Mn[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const o=i.match(/\s|\//),s=e.match(/\s|\//);if(o||s){const a=[`Unable to register library "${i}" with version "${e}":`];o&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&s&&a.push("and"),s&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),b.warn(a.join(" "));return}S(new E(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ln="firebase-heartbeat-database",Hn=1,k="firebase-heartbeat-store";let q=null;function ze(){return q||(q=H(Ln,Hn,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(k)}catch(n){console.warn(n)}}}}).catch(t=>{throw w.create("idb-open",{originalErrorMessage:t.message})})),q}async function jn(t){try{const n=(await ze()).transaction(k),r=await n.objectStore(k).get(Ge(t));return await n.done,r}catch(e){if(e instanceof A)b.warn(e.message);else{const n=w.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});b.warn(n.message)}}}async function _e(t,e){try{const r=(await ze()).transaction(k,"readwrite");await r.objectStore(k).put(e,Ge(t)),await r.done}catch(n){if(n instanceof A)b.warn(n.message);else{const r=w.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});b.warn(r.message)}}}function Ge(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xn=1024,Vn=30;class Un{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new Kn(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Te();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(s=>s.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:i}),this._heartbeatsCache.heartbeats.length>Vn){const s=qn(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){b.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Te(),{heartbeatsToSend:r,unsentEntries:i}=Wn(this._heartbeatsCache.heartbeats),o=je(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(n){return b.warn(n),""}}}function Te(){return new Date().toISOString().substring(0,10)}function Wn(t,e=xn){const n=[];let r=t.slice();for(const i of t){const o=n.find(s=>s.agent===i.agent);if(o){if(o.dates.push(i.date),Ae(n)>e){o.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),Ae(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class Kn{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Ve()?Ue().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await jn(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return _e(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return _e(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Ae(t){return je(JSON.stringify({version:2,heartbeats:t})).length}function qn(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let r=1;r<t.length;r++)t[r].date<n&&(n=t[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye=1e4,Xe=`w:${ue}`,Qe="FIS_v2",Yn="https://firebaseinstallations.googleapis.com/v1",Xn=60*60*1e3,Qn="installations",Zn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ir({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const r=et(t),i=rt(t),o=e.getImmediate({optional:!0});if(o){const l=await o.getHeartbeatsHeader();l&&i.append("x-firebase-client",l)}const s={fid:n,authVersion:Qe,appId:t.appId,sdkVersion:Xe},a={method:"POST",headers:i,body:JSON.stringify(s)},c=await it(()=>fetch(r,a));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:tt(l.authToken)}}else throw await nt("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const st=new Map;function at(t,e){const n=j(t);ct(n,e),ur(n,e)}function ct(t,e){const n=st.get(t);if(n)for(const r of n)r(e)}function ur(t,e){const n=lr();n&&n.postMessage({key:t,fid:e}),dr()}let I=null;function lr(){return!I&&"BroadcastChannel"in self&&(I=new BroadcastChannel("[Firebase] FID Change"),I.onmessage=t=>{ct(t.data.key,t.data.fid)}),I}function dr(){st.size===0&&I&&(I.close(),I=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr="firebase-installations-database",hr=1,T="firebase-installations-store";let z=null;function le(){return z||(z=H(fr,hr,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(T)}}})),z}async function F(t,e){const n=j(t),i=(await le()).transaction(T,"readwrite"),o=i.objectStore(T),s=await o.get(n);return await o.put(e,n),await i.done,(!s||s.fid!==e.fid)&&at(t,e.fid),e}async function ut(t){const e=j(t),r=(await le()).transaction(T,"readwrite");await r.objectStore(T).delete(e),await r.done}async function x(t,e){const n=j(t),i=(await le()).transaction(T,"readwrite"),o=i.objectStore(T),s=await o.get(n),a=e(s);return a===void 0?await o.delete(n):await o.put(a,n),await i.done,a&&(!s||s.fid!==a.fid)&&at(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fe(t,e=!1){let n;const r=await x(t.appConfig,o=>{if(!dt(o))throw _.create("not-registered");const s=o.authToken;if(!e&&Sr(s))return o;if(s.requestStatus===1)return n=vr(t,e),o;{if(!navigator.onLine)throw _.create("app-offline");const a=Tr(o);return n=Ir(t,a),a}});return n?await n:r.authToken}async function vr(t,e){let n=await De(t.appConfig);for(;n.authToken.requestStatus===1;)await ot(100),n=await De(t.appConfig);const r=n.authToken;return r.requestStatus===0?fe(t,e):r}function De(t){return x(t,e=>{if(!dt(e))throw _.create("not-registered");const n=e.authToken;return Ar(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function Ir(t,e){try{const n=await yr(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return await F(t.appConfig,r),n}catch(n){if(Ze(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await ut(t.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await F(t.appConfig,r)}throw n}}function dt(t){return t!==void 0&&t.registrationStatus===2}function Sr(t){return t.requestStatus===2&&!_r(t)}function _r(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+Xn}function Tr(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function Ar(t){return t.requestStatus===1&&t.requestTime+Ye<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cr(t){const e=t,{installationEntry:n,registrationPromise:r}=await de(e);return r?r.catch(console.error):fe(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dr(t,e=!1){const n=t;return await kr(n),(await fe(n,e)).token}async function kr(t){const{registrationPromise:e}=await de(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function g(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function xr(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(n),i=new Uint8Array(r.length);for(let o=0;o<r.length;++o)i[o]=r.charCodeAt(o);return i}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ai(t){if(!t||!t.options)throw X("App Configuration Object");if(!t.name)throw X("App Name");const e=["projectId","apiKey","appId","messagingSenderId"],{options:n}=t;for(const r of e)if(!n[r])throw X(r);return{appName:t.name,projectId:n.projectId,apiKey:n.apiKey,appId:n.appId,senderId:n.messagingSenderId}}function X(t){return h.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gi(t,e){const n=e.data;if(!n.isFirebaseMessaging)return;t.onMessageHandler&&n.messageType===O.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(Me(n)):t.onMessageHandler.next(Me(n)));const r=n.data;si(r)&&r[jr]==="1"&&await hi(t,n.messageType,r)}const Be="@firebase/messaging",Re="0.12.22";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
